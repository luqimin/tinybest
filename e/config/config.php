...
$ecms_config['db']['dbusername']='best';	//数据库用户名
$ecms_config['db']['dbpassword']='2488759y';	//数据库密码
$ecms_config['db']['dbname']='best';	//数据库名
$ecms_config['db']['setchar']='utf8';	//设置默认编码
$ecms_config['db']['dbchar']='utf8';	//数据库默认编码
$ecms_config['db']['dbtbpre']='best_';	//数据表前缀
...
$ecms_config['esafe']['ecookiernd']='5yrDs2l9cOvbpQg8BYcPcOyzF8LFTi';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='ujqpx';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='cjuid';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='VF9kR2r6k5lZwii23IbdTIjcmz5wsu';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='PRv06WLUtIjqeVvrjJs1Ym4kuJTtLP';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'狂暴酷炫吊炸天',
'newsurl'=>'/',
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'P4N1IM7GlRFAFxuxEqb5tMgn7CXXfr',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/platform/\">平台依托单位</a>&nbsp;|&nbsp;<a href=\"/team/\">专家团队</a>&nbsp;|&nbsp;<a href=\"/technology/\">技术</a>&nbsp;|&nbsp;<a href=\"/about/\">关于我们</a>&nbsp;|&nbsp;<a href=\"/news/\">新闻中心</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'openfileserver'=>0,
'fs_purl'=>'',
'closemods'=>',down,movie,shop,pay,rss,member,pl,print,mconnect,',
'fieldandtop'=>0,
'fieldandclosetb'=>'',
'filedatatbs'=>',1,',
'filedeftb'=>1,
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,techurl,special.field,newstime,titlepic,smalltext,writer,befrom,newstext,',
'qenter'=>',title,ftitle,special.field,titlepic,smalltext,writer,befrom,newstext,',
'listtempf'=>',title,ftitle,techurl,newstime,titlepic,smalltext,diggtop,',
'tempf'=>',title,ftitle,techurl,newstime,titlepic,smalltext,writer,befrom,newstext,diggtop,',
'mustqenterf'=>',title,newstext,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,ftitle,techurl,smalltext,',
'cj'=>',title,ftitle,newstime,titlepic,smalltext,writer,befrom,newstext,',
'canaddf'=>',title,ftitle,techurl,newstime,titlepic,smalltext,writer,befrom,newstext,',
'caneditf'=>',title,ftitle,techurl,newstime,titlepic,smalltext,writer,befrom,newstext,',
'tbmainf'=>',title,titlepic,newstime,ftitle,smalltext,diggtop,techurl,',
'tbdataf'=>',writer,befrom,newstext,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,techurl,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
