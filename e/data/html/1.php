...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>相关链接（可不填）</td><td bgcolor='ffffff'><textarea name="techurl" cols="60" rows="10" id="techurl"><?=$ecmsfirstpost==1?"http://":ehtmlspecialchars(stripSlashes($r[techurl]))?></textarea>
